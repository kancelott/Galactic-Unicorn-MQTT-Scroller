...
config['server'] = '10.0.0.15'  # Your MQTT Server
config['port'] = 1883 # Your MQTT Port
config['user'] = 'mqtt' # Your MQTT User Name
config['password'] = 'mqttmqttmqttmqtt' # Your MQTT Password

config['ssid'] = 'MicrowaveSushi' #Your Wifi SSID
config['wifi_pw'] = 'Would you please let me in and eat all your chocolate cookies?' #Your Wifi Password
